...
/**
 * UserServiceImpl handles any additional services that need to be made before
...
public class UserServiceImpl implements UserService {
	 ...
	 * 
	 * @param isDriver
	 *            represents if the user is a driver or rider.
	 ...
	 * 
	 * @param user
	 *            represents the new User object being sent.
	 ...
	 * 
	 * @param user
	 *            represents the updated User object being sent.

...
//		
//		User expected = new User(1, "userName", new Batch(), "adonis", "cabreja", "adonis@gmail.com", "123-456-7890", true);
//		when(ur.findById(1).get()).thenReturn(expected);
...
//	}
	...
	public void testGettingUserByUsername() {
		...
		expected.add(new User(1, "userName", new Batch(), "adonis", "cabreja", "adonis@gmail.com", "123-456-789", true));
	...
	public void testAddingUser() {
		...
		User expected = new User(1, "userName", new Batch(), "adonis", "cabreja", "adonis@gmail.com", "123-456-789", true);
